...
### 기능 레이어 (Tier 1) — 산업 공통 방법론 및 데이터 서비스

| 도메인 | 커버리지 | 워크플로우 수 |
|--------|----------|-----------|
| `psm` | 공정안전관리 (OSHA 14요소) | 15 |
| `msds` | 화학물질 안전데이터 / GHS Rev 9 | 7 |
| `training` | 안전보건교육 관리 (OSHA-KR 제13/29/31/32/114조) | 8 |
| `risk-assessment` | 위험성평가 / OSHA-KR 제36조 (4M법법, JSA, MOC연동, 사후평가) | 5 |
| `incident-investigation` | 사고 조사 및 RCA / OSHA-KR 제57조 + SAPA 제5조 (5-Why, 보타이, CAPA) | 5 |
| `asset-integrity` | 설비 자산 무결성 및 예방 정비 / OSHA-KR 제38조 + KOSHA Guide M-155 | 4 |
| `contractor-safety` | 수급업체 안전관리 (TAR/대정수 인력 서지 시나리오) | 1 |
| `occupational-health` | 작업환경 보건 감시 (TAR/대정수 건강스크리닝) | 1 |
