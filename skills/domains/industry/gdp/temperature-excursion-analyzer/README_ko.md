# temperature-excursion-analyzer

> **`SKILL.md` 프론트매터에서 생성됨 (2026-08-28 per-skill README 표준, CONSTITUTION §6.2).** 자유롭게 보강하세요 — 이 파일은 자동 재생성되지 않습니다.

## 목적

Analyze temperature excursion events in cold chain pharmaceutical distribution. Determines product quality impact per Stability + GDP guidelines.
