 ...
 *
 * Examples:
 *   bun scripts/co-safety/scaffold-industry.ts --industry datacenter --dry-run
 *   bun scripts/co-safety/scaffold-industry.ts --industry datacenter
 *   bun scripts/co-safety/scaffold-industry.ts --industry battery --unique-wfs silane-gas-leak-response,battery-room-fire-suppression --dry-run
 *   bun scripts/co-safety/scaffold-industry.ts --validate
 *
 * @version 0.1.1
 */
...
> **Status**: Scaffold (draft) — generated by \`scripts/co-safety/scaffold-industry.ts\` (Task A-01, Phase 0).
...
> **상태**: 스캐폴드(초안) — \`scripts/co-safety/scaffold-industry.ts\`(Task A-01, Phase 0)가 생성.
...
USAGE
  bun scripts/co-safety/scaffold-industry.ts --industry <code> [options]
  bun scripts/co-safety/scaffold-industry.ts --validate
  bun scripts/co-safety/scaffold-industry.ts --all-dry-run
...
function main(): void {
    ...
    console.log(`${GREEN}\n✓ generation complete for '${plan.industry}'. Run \`bun scripts/co-safety/safety-audit.ts\` next.${RESET}`);
}
