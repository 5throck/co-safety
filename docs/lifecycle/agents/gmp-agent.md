...
- [x] Section A legal basis resolves to on-disk metadata: 약사법 Art 34 + 의약품등기준규정 (`regulations/KR/MFDS-GMP.yaml`) with ICH Q7/Q9/Q10 and PIC/S PE 009 as multi-source anchors
