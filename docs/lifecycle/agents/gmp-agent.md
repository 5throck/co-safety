...
- [x] All 3 owned skills exist under `skills/gmp//`: `change-control`, `deviation-capa`, and `qrm` (ICH Q9 methodology applied across all GMP workflows), each with `SKILL.md`
