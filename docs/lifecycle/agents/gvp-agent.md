...
- [x] Both owned skills exist under `skills/gvp//`: `signal-detector` (PRR/ROR/BCPNN/EBGM disproportionality methods) and `benefit-risk-assessor` (EU GVP Module 12 frameworks), each with `SKILL.md`
