...
- [x] Owned skill `iso14971-risk-scorer` exists at `skills/iso14971-risk-scorer//SKILL.md` (AGENTS.md skills table, owner meddevice-agent); workforce/process risks explicitly routed away to risk-assessment-agent
