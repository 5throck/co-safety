...
- [x] Both owned skills exist under `skills/powergen//`: `arc-flash-analyzer` (IEEE 1584 incident energy / PPE categories) and `ess-fire-risk-assessor` (lithium-ion thermal runaway), each with `SKILL.md`
