...
- [x] Both owned skills exist under `skills/gdp//`: `dts-verification` and `temperature-excursion-analyzer`, each with `SKILL.md`; the excursion-analysis step is wired into workflow pattern step 4
