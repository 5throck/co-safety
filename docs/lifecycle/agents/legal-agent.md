...
- [x] Live-retrieval toolchain named: `mcp-kr-legislation` MCP server plus K-Skill OpenAPI for statute, enforcement-decree, and MOEL-guideline retrieval; unreachable/contradictory service escalates to PM (CSO)
