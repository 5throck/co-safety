...
- [x] Tool scope restricted: Write/Edit limited to `memory/*.md`, Bash read-only (`git status/diff/log`, `bun scripts/audit.ts`, `bun scripts/co-safety/safety-audit.ts`); specialist work is delegated, never substituted
