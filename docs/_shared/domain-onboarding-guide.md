...
If the domain has cross-cutting methodology skills (like `gmp-qrm`), create `skills/<skill-name>/SKILL.md` (flat layout per ADR-0075, with `metadata.type: domain` and `mirror: false` frontmatter).
