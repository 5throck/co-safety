...
# 스킬 실행 (rule-based)
bun skills/gmp-qrm//fmea-scoring.ts                    # FMEA 위해 평가
bun skills/ghs-classifier//ghs-classifier.ts      # GHS 분류
bun skills/fall-hazard-assessor//fall-hazard-assessor.ts  # 추락 위해
