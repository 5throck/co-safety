...
lifecycle:
  ...
  governance: docs/lifecycle/agents/gdp-agent.md
---
...
4. Apply temperature monitoring analysis via `skills/temperature-excursion-analyzer//`
...
| Skill | `skills/gdp//{temperature-excursion-analyzer, dts-verification}/` |
