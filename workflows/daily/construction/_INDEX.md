...
|----------|-------------|------|--------|
| TBM (Tool Box Meeting) | Daily safety briefing before work starts | General | ✅ Active — `workflows/domains/industry/ehsconst/tbm-tool-box-meeting/` (construction-dedicated); cross-industry TBM skill at `skills/tool-box-meeting//` + 14 industry profiles via `tbm-pre-work-briefing` workflows |
...
| Fall Protection | Harness inspection, scaffolding checks | High | ✅ Active — `workflows/domains/industry/ehsconst/fall-prevention/` + `skills/fall-hazard-assessor//` |
