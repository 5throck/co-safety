...
8. **고압가스 설비 통제 (High-pressure gas facility control)**: 무기 질소·이산화탄소 불활성 가스(inert gas) 사용 시 고압가스 안전관리 및 사업법 Article 11(안전관리자), Article 13(안전점검), Article 15(시설 기준), Article 24(응급조치), Article 26(조치명령)과 연계.
