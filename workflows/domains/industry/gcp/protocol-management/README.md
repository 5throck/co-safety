# protocol-management Workflow

## 1. Objective
Manage clinical trial protocol lifecycle per ICH E6(R3) Section 3 — design, amendment, IRB submission.

## 2. Workflow Steps
1. **Protocol drafting**: Investigator/Sponsor per ICH E6(R3) Section 3.
2. **Statistical analysis plan**: Per ICH E9(R1).
