...
2. **통제 위계 적용 (Hierarchy of controls)**:
   ...
   3. **관리 조치 (Administrative)**: 폐기물관리법 Article 25 허가 조건 준수, 화학물질관리법 Article 23 사고대비물질 관리계획서 비치, MSDS 작성·비치(산업안전보건법 Article 110), 안전작업허가서(화학/밀폐/화재), 반입 폐기물 성분 검수·매니페스트, 정기 작업환경측정·특수건강진단, 누출 대응 훈련.
